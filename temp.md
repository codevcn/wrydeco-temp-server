...
```text
Ảnh 1 chứa khung cảnh tham chiếu, ảnh 2 chứa sản phẩm tham chiếu (sản phẩm gốc), tôi dùng ChatGPT Image 2 để tạo ảnh, bạn hãy viết 1 prompt để yêu cầu ChatGPT Image 2 thực hiện tuần tự các bước sau:
...
```text
Ảnh 1 chứa khung cảnh tham chiếu, ảnh 2 chứa sản phẩm tham chiếu (sản phẩm gốc), tôi dùng ChatGPT Image 2 để tạo ảnh, bạn hãy viết 1 prompt để yêu cầu ChatGPT Image 2 tạo 1 ảnh mới đặt sản phẩm trong ảnh 2 vào khung cảnh trong ảnh 1. Yêu cầu cho ảnh kết quả là phải khóa (giữ nguyên) chính xác 100%:
- kết cấu & màu sắc của sản phẩm tham chiếu
- ko được lai (pha trộn) sản phẩm đang ở trong khung cảnh tham chiếu với sản phẩm tham chiếu.
- ánh sáng và các chi tiết vật thể trong khung cảnh tham chiếu
- ko được regenerate lại cả khung cảnh để tránh tạo cảm giác nhìn khung cảnh bị "AI", phải giữ cứng khung cảnh
